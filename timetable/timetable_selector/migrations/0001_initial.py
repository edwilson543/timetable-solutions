    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('year_group', models.IntegerField(choices=[(1, 'One'), (2, 'Two'), (3, 'Three'), (4, 'Four'), (5, 'Five')])),
            ],
        ),
        migrations.CreateModel(
            name='Teacher',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('pupils', models.ManyToManyField(related_name='pupils', to='timetable_selector.pupil')),
                ('teacher', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='teacher', to='timetable_selector.teacher')),
                ('time_slots', models.ManyToManyField(related_name='slots', to='timetable_selector.timetableslot')),
            ],
        ),
    ]
