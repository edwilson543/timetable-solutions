"""
Module defining the constant values (hexadecimal colour codes) assigned to subject names.
"""
...
class TimetableColour(Enum):
    """
    Enumeration of the hexadecimal colours to use for the timetables in the UI.
    For certain subject types (lunch / free), a specific colour is given, otherwise, we assign colours based on the most
    periods.
    """
    ...
    @classmethod
    def get_colours_for_pupil_timetable(cls, classes: models.FixedClassQuerySet) -> Dict:
        """
        ...
        unranked_colours = cls.get_unranked_colours()
        ...
        class_colours = cls.get_unranked_colours() | ranked_colours
        return class_colours

    @classmethod
    def get_unranked_colours(cls) -> Dict[str, str]:
        """
