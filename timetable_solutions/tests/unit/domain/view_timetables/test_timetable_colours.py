...
class Test(TestCase):
    ...
    def test_get_colours_for_pupil_timetable_returns_expected_colour_dictionary(self):
        ...
        expected_colour_dict = {
            ...
            "FRENCH": "#ffbfd6",
            "MATHS": "#c8d4e3",
            "ENGLISH": "#b3f2b3",  # Ranked colours
        }

        # Execute test unit
        colours_dict = TimetableColourAssigner.get_colours_for_pupil_timetable(
            lessons=lessons
        )
    ...
    def test_get_colours_for_teacher_timetable_returns_expected_colour_dictionary(self):
        ...
        # Execute test unit
        colours_dict = TimetableColourAssigner.get_colours_for_teacher_timetable(
            lessons=lessons
        )
    ...
    def test_get_generic_period_colours(self):
        ...
        models.Lesson.create_new(
            school_id=123456,
            lesson_id="Morning break Y1",
            subject_name="Morning break",
        ...
        # Execute test unit
        generic_period_colours = TimetableColourAssigner._get_generic_period_colours(
            lessons=lessons
        )

        # Check outcome
        assert generic_period_colours == {
            "LUNCH": "#b3b3b3",
            "MORNING BREAK": "#bfbfbf",  # Morning break gets caps
    ...
    def test_check_lesson_for_colour_in_regex_successful_meal_time_match_expected(self):
        ...
        for meal_time_string in meal_time_strings:
            colour_code = TimetableColourAssigner.check_lesson_for_colour_in_regex(
                lesson_name=meal_time_string
            )
    ...
    def test_check_lesson_for_colour_in_regex_successful_break_match_expected(self):
        ...
        for break_time_strings in break_time_strings:
            colour_code = TimetableColourAssigner.check_lesson_for_colour_in_regex(
                lesson_name=break_time_strings
            )
            assert colour_code == TimetableColourAssigner.Colour.BREAK.value

    def test_check_lesson_for_colour_in_regex_successful_free_period_match_expected(
        self,
    ):
        """
        ...
        for free_time_strings in free_period_strings:
            colour_code = TimetableColourAssigner.check_lesson_for_colour_in_regex(
                lesson_name=free_time_strings
            )
            assert colour_code == TimetableColourAssigner.Colour.FREE.value

    def test_check_lesson_for_colour_in_regex_unsuccessful_match_against_all_options(
        self,
    ):
        """
