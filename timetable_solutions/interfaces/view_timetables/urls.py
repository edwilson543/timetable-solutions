...
urlpatterns = [
    ...
    path('teachers/<int:id>', views.teacher_timetable, name=UrlName.TEACHER_TIMETABLE.value),
    path('pupils/', views.pupil_navigator, name=UrlName.PUPILS_NAVIGATOR.value),
    path('pupils/<int:id>', views.pupil_timetable, name=UrlName.PUPIL_TIMETABLE.value)
]
