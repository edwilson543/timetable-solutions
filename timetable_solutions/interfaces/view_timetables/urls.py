...
urlpatterns = [
    ...
    path('pupils/<int:pupil_id>/download/', views.pupil_timetable_download_csv,
         name=UrlName.PUPIL_TIMETABLE_DOWNLOAD.value),
    path('teachers/<int:teacher_id>/download/', views.teacher_timetable_download_csv,
         name=UrlName.TEACHER_TIMETABLE_DOWNLOAD.value)
]
