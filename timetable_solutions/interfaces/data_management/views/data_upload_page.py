...
class UploadPage(LoginRequiredMixin, TemplateView):
    ...
    def get_context_data(self, *args: Any, **kwargs: Any) -> UploadPageContext:
        ...
        upload_status = data_management.UploadStatusTracker.get_upload_status(
            school=school
        )
        ...
        context: UploadPageContext = {
            "required_forms": {
                "teachers": RequiredUpload(
                    ...
                    reset_warning=data_management.ResetWarning.teachers,
                ),
                "classrooms": RequiredUpload(
                    ...
                    reset_warning=data_management.ResetWarning.classrooms,
                ),
                "year_groups": RequiredUpload(
                    ...
                    reset_warning=data_management.ResetWarning.year_groups,
                ),
                "breaks": RequiredUpload(
                    ...
                    reset_warning=data_management.ResetWarning.breaks,
                ),
                "pupils": RequiredUpload(
                    form_name="Pupils",
                    ...
                    reset_warning=data_management.ResetWarning.pupils,
                ),
                "timetable": RequiredUpload(
                    ...
                    reset_warning=data_management.ResetWarning.timetable,
                ),
                "lessons": RequiredUpload(
                    form_name="Lessons",
                    ...
                    reset_warning=data_management.ResetWarning.lessons,
                ),
            }
        }
        return context
